...
class Multi_Planet_Transfer:
    ...
    '''
    def __init__(self, planet_list: List[Planet_Info], max_c3=None, max_dvinf=1, max_vinfm=None, max_tof=None): # TODO: check if that 1 is m/s or km/s
...
def pcp(planet1, planet2, leg_number, contour_info, num_ticks=11, n_revs=0, plot=True):
    ...
    if plot==True:
        ...
        planet_transfer = Planet_Transfer(planet1, planet2).set_pos_search(transfer_tof=tof, leg_num=leg_number, vinfp_C3=C3, vinfm=v_inf)
