'''
This file is strictly to hold constants of any and all astrodynamics to be called upon.
This will allow for all to be the same across files and not need to constantly need to go searching for them
All units will be given in meters and seconds unless specified elsewhere for higher accuracy in propagation
'''
...
Meeus = {'Venus': Venus, 'Earth': Earth, 'Mars': Mars, 'Jupiter': Jupiter, 'Saturn': Saturn, 'Uranus': Uranus, 'Neptune': Neptune, 'Pluto': Pluto}


'''
Constants for a given planet
'''
VENUS = {'mu':MU_VENUS_KM, 'radius':R_VENUS_KM, 'period':VENUS_PERIOD_DAYS, 'name':'Venus'}
EARTH = {'mu':MU_EARTH_KM, 'radius':R_EARTH_KM, 'period':EARTH_PERIOD_DAYS, 'name':'Earth'}
MARS = {'mu':MU_MARS_KM, 'radius':R_MARS_KM, 'period':MARS_PERIOD_DAYS, 'name':'Mars'}
JUPITER = {'mu':MU_JUPITER_KM, 'radius':R_JUPITER_KM, 'period':JUPITER_PERIOD_DAYS, 'name':'Jupiter'}
URANUS = {'mu':MU_URANUS_KM, 'radius':R_URANUS_KM, 'period':URANUS_PERIOD_DAYS, 'name':'Uranus'}
NEPTUNE = {'mu':MU_NEPTUNE_KM, 'radius':R_NEPTUNE_KM, 'period':NEPTUNE_PERIOD_DAYS, 'name':'Neptune'}
PLUTO = {'mu':MU_PLUTO_KM, 'radius':R_PLUTO_KM, 'period':PLUTO_PERIOD_DAYS, 'name':'Pluto'}
PLANETS = {'Venus':VENUS, 'Earth':EARTH, 'Mars':MARS, 'Jupiter':JUPITER, 'Uranus':URANUS, 'Neptune':NEPTUNE, 'Pluto':PLUTO}
